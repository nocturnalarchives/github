...
/*
*
* This is the iThemes Exhchange archive page to show the product-categories for a layout similar to the store page.
*
*/
...
add_action( 'genesis_entry_content', 'jessica_do_post_content', 8 );
remove_action( 'genesis_entry_header', 'genesis_do_post_title');
remove_action( 'genesis_entry_header', 'genesis_post_info', 12 );
remove_action( 'genesis_entry_footer', 'genesis_post_meta' );


function jessica_do_post_content() {
