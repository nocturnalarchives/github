					...
					<?php echo '<h1 class="entry-title">'. get_the_title() .'</h1>'; ?>
						...
						<form class="product_form" enctype="multipart/form-data" action="<?php echo esc_url( wpsc_this_page_url() ); ?>" method="post" name="1" id="product_<?php echo wpsc_the_product_id(); ?>">
							...
							<?php if ( wpsc_product_has_personal_text() ) : ?>
								<fieldset class="custom_text">
									<legend><?php _e( 'Personalize Your Product', 'jessica' ); ?></legend>
									<p><?php _e( 'Complete this form to include a personalized message with your purchase.', 'jessica' ); ?></p>
							...
							<?php if ( wpsc_product_has_supplied_file() ) : ?>
								...
								<fieldset class="custom_file">
									<legend><?php _e( 'Upload a File', 'jessica' ); ?></legend>
									<p><?php _e( 'Select a file from your computer to include with this purchase.', 'jessica' ); ?></p>
						...
						<?php /** the variation group HTML and loop ends here */?>
							...
							<?php if(wpsc_has_multi_adding()): ?>
                            	<fieldset><legend class="quantity-legend"><?php _e('Quantity', 'jessica'); ?></legend>
							...
							<?php if((get_option('hide_addtocart_button') == 0) &&  (get_option('addtocart_or_buynow') !='1')) : ?>
								<?php if(wpsc_product_has_stock()) : ?>
									<div class="wpsc_buy_button_container">
											...
											<input class="wpsc_buy_button" type="submit" value="<?php echo wpsc_product_external_link_text( wpsc_the_product_id(), __( 'Buy', 'jessica' ) ); ?>" onclick="return gotoexternallink('<?php echo esc_url( $action ); ?>', '<?php echo wpsc_product_external_link_target( wpsc_the_product_id() ); ?>')">
											<?php else: ?>
								...
								<?php else : ?>
									<p class="soldout"><?php _e('This product has sold out.', 'jessica'); ?></p>
								<?php endif ; ?>
							<?php endif ; ?>
